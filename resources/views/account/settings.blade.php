@extends('layouts.v8.master_v8')
@push('head')
@endpush
@section('content')
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <!--begin::Toolbar-->
    @include('layouts.v8.toolbar._base')
    <!--end::Toolbar-->
        <!--begin::Post-->
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <!--end::Card header-->
                    <!--begin::Content-->
                @include('system.account._security_account')
                <!--end::Content-->
                </div>
                <!--end::Sign-in Method-->
                <!--begin::Basic info-->
                <div class="card mb-5 mb-xl-10">
                    ...
                    <!--begin::Card header-->
                    <!--begin::Content-->
                @include('system.account._profile_detail')
                <!--end::Content-->
                </div>
                <!--end::Basic info-->
                <div class="card mb-5 mb-xl-10">
                    ...
                    @include('system.account._two_factor_authentication')
